...
final class PeriodInsert extends Constraint
{
    ...
    public const NEGATIVE_BREAK_ERROR = 'kimai-period-insert-bundle-11';
    public const BREAK_DURATION_ERROR = 'kimai-period-insert-bundle-12';
    public const MISSING_DAY_ERROR = 'kimai-period-insert-bundle-13';
    public const PROJECT_NOT_STARTED_ERROR = 'kimai-period-insert-bundle-14';
    public const PROJECT_ALREADY_ENDED_ERROR = 'kimai-period-insert-bundle-15';
    public const TIME_RANGE_IN_FUTURE_ERROR = 'kimai-period-insert-bundle-16';
    public const BEGIN_IN_FUTURE_ERROR = 'kimai-period-insert-bundle-17';
    public const END_IN_FUTURE_ERROR = 'kimai-period-insert-bundle-18';
    public const RECORD_OVERLAPPING_ERROR = 'kimai-period-insert-bundle-19';
    public const BUDGET_USED_ERROR = 'kimai-period-insert-bundle-20';
